...
export const TEAM: TeamMember[] = [
  {
    ...
    role: 'Owner / Operator',
    bio: [
      'Mike Franco has spent 25 years turning design and marketing challenges into results that hold up in print and online. His background spans graphic and web design, with deep roots in both the design and print sectors — a combination that has become increasingly rare as the industry has specialized.',
