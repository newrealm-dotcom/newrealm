  ...
  return (
    ...
    >
      <div className="mx-auto w-full max-w-[1400px]">
        <p className="eyebrow mb-6">01 / Realm — Hero</p>
        ...
        <h1 className="max-w-4xl font-[family-name:var(--font-display)] text-[13vw] font-light leading-[0.95] tracking-tight text-[var(--color-bone)] sm:text-[9vw] lg:text-[6.4vw]">
          <KineticText as="span" text="We build worlds" className="block" />
          <KineticText as="span" text="worth stepping into." className="gradient-text block" delay={0.15} />
        </h1>
        ...
        <div className="mt-10 flex max-w-xl flex-col gap-8 md:mt-14 md:flex-row md:items-end md:justify-between">
          <p className="text-lg text-[var(--color-bone-dim)]">
            New Realm Graphics is a 3D &amp; motion design studio — precision visual
            worlds, engineered for brands with something worth showing.
          </p>
