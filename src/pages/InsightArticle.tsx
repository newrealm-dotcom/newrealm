    ...
    <>
      ...
      <article className="border-b border-[var(--color-line)] px-6 py-16 md:px-10 md:py-20">
        <div className="mx-auto max-w-[var(--container-content)]">
          ...
          <p className="eyebrow mb-4 mt-6">{article.category}</p>
          <h1 className="font-[family-name:var(--font-display)] text-4xl font-medium leading-tight text-[var(--color-ink)] md:text-5xl">
            {article.title}
          </h1>
          <p className="prose-copy mt-6 text-lg text-[var(--color-ink-dim)]">{article.excerpt}</p>
        </div>
      </article>
